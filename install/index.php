...
class bestclick_api extends CModule
{
	var $MODULE_NAME;
	var $MODULE_DESCRIPTION;
	var $MODULE_VERSION;
	var $MODULE_VERSION_DATE;
	var $MODULE_ID = 'bestclick.api';
	...
	function __construct()
	{
		...
		if (is_array($arModuleVersion))
		{
			...
			$this->MODULE_VERSION_DATE = array_key_exists('DATE', $arModuleVersion)
				? $arModuleVersion['DATE'] : '2024-02-11 23:58:25';
		}

		$this->MODULE_NAME = Loc::getMessage('BESTCLICK_API_MODULE_NAME');
		$this->MODULE_DESCRIPTION = Loc::getMessage('BESTCLICK_API_MODULE_DESCRIPTION');

		$this->PARTNER_NAME = Loc::getMessage('BESTCLICK_API_MODULE_PARTNER');
		$this->PARTNER_URI = Loc::getMessage('BESTCLICK_API_MODULE_PARTNER_URI');
	...
	function DoInstall(): void
	{
		...
		{
			$APPLICATION->ThrowException(Loc::getMessage('BESTCLICK_API_MODULE_INSTALL_ERROR_VERSION'));
		}
		...
		$APPLICATION->IncludeAdminFile(
			Loc::getMessage('BESTCLICK_API_MODULE_INSTALL_TITLE'),
